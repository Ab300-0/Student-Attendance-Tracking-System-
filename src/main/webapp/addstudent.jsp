...
<div class="container">
  <div class="card">
    ...
    <% if (count == 0) { %>
      <h1>Student Already Existed With This Roll No. </h1>
      <p>The student you are trying to add already exists in the system.</p>
    <% } else { %>
      <h1><%=count %> Student Added Successfully</h1>
      <p>Thank you for using our system. We appreciate your business!</p>
    <% } %>
    
    <a href="nav.html">Back to Home</a>
    <a id="a2" href="add.html">Add More Student</a>
  </div>
</div>
</body>
</html>
